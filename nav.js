...
const PPR_NAV = {
  ...
  rounds: [
    ...
    // { label: 'Round 8', href: 'round-8.html' }, ← uncomment when ready
  ],
...
(function buildNav() {
  ...
  const dropdownHTML = `
    <li>
      <button
        class="ppr-dropdown-btn${onRoundPage ? ' active-parent' : ''}"
        id="ppr-rounds-btn"
        onclick="PPR_NAV._toggle()"
        aria-expanded="false"
        aria-haspopup="true"
      >Rounds <span class="chevron">▼</span></button>
      <div class="ppr-dropdown-menu" id="ppr-rounds-menu">
        ${dropdownItems}
      </div>
    </li>`;
